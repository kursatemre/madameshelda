...
const workshops = [
  {
    ...
    description: "Hiçbir deneyim gerekmez. Renk, form ve dokunuşla tanışın.",
    level: "Başlangıç",
    duration: "3 saat",
  ...
  },
  {
    ...
    description: "Mekânı dönüştüren büyük ölçekli tasarımların sırları.",
    level: "Orta",
    duration: "4 saat",
    ...
    <>
      ...
      <section className="pt-32 lg:pt-40 pb-16 lg:pb-24 px-6 lg:px-12 bg-brown overflow-hidden relative">
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <h1
            className="font-serif text-cream leading-[0.9] mb-8"
            style={{ fontSize: "clamp(3rem, 7vw, 6rem)", fontStyle: "italic" }}
          >
            Ellerinizle
            <br />
            <span className="text-gold">yaratın.</span>
          </h1>
          <p className="text-cream/50 font-light text-sm lg:text-base leading-relaxed max-w-md">
            Soma, Manisa'daki atölyemizde; çiçek, form ve rengin diliyle
            buluşuyoruz. Her seviyeye açık, küçük gruplarla çalışıyoruz.
          </p>
        </div>
      </section>
            ...
            {workshops.map((ws, i) => (
              ...
              >
                ...
                >
                  ...
                  <div className="absolute top-4 right-4 font-label text-cream/40 text-[0.55rem]">
                    0{i + 1}
                  </div>
                </div>
                ...
                <div className="p-6 flex flex-col flex-1 bg-white">
                  <h2
                    className="font-serif text-[#1a1a1a] text-xl mb-3 group-hover:text-brown transition-colors duration-300"
